...
module.exports = (app) => {
  ...
  app.get("/getPendingContributions", [auth_middleware.validateToken, auth_middleware.addUserData, auth_middleware.isAdmin], views_controller.getPendingContributions);
